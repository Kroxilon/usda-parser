...
export type USDA_ValueTypes = string | boolean | number | USDA_Array<any> | Readonly<USDA_Array<any>> | USDA_ExternalReferenceImport | USDA_ExternalReference | USDA_ObjectValue<any> | null | undefined;
...
type PotentialObjectDeclarationList<T extends USDA_ValueTypes, TArrayItem extends USDA_ValueTypes | any> = TArrayItem extends USDA_ValueTypes ? USDA_ObjectDeclarationList<TArrayItem> : SimpleObjectDeclarations<T>;
type SimpleObjectDeclarations<T extends USDA_ValueTypes> = USDA_ObjectDeclarationList<T> | USDA_ObjectDeclarationEntries<T>;
export type USDA_ObjectDeclarations<T extends USDA_ValueTypes> = T extends (infer TArrayItem)[] ? PotentialObjectDeclarationList<T, TArrayItem> : SimpleObjectDeclarations<T>;
...
export type USDA_Array<T extends USDA_ValueTypes> = T[];
...
export type USDA_Statement = USDA_ClassDefinition | USDA_Definition | USDA_VariantSet;
export type USDA_DefinitionStatement = USDA_Statement | USDA_Declaration<any>;
...
export declare enum USDA_DefinitionType {
    Def = "def",
    Over = "over"
}
...
export declare enum USDA_AssignmentKeyword {
    /**
