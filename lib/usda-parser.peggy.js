...
function peg$parse(input, options) {
    ...
    const peg$c33 = function (keyword) { return keyword; };
    const peg$c34 = function (keyword, type, reference, value) { return value; };
    const peg$c35 = function (keyword, type, reference, value, desc) { return desc; };
    const peg$c36 = function (keyword, type, reference, value, descriptor) {
        return {
            type: 'declaration',
            keyword,
            defineType: type,
    ...
    const peg$c49 = function (id) { return id; };
    const peg$c50 = function (id, name, desc) { return desc; };
    const peg$c51 = function (id, name, descriptor, classDeclarations) {
        return {
    ...
    const peg$c79 = function (head, tail) {
        return {
            type: 'objectDeclarationList',
            values: [head].concat(tail),
        };
    };
    const peg$c80 = function (keyword, type, reference, value) {
        return {
            keyword,
            defineType: type,
            reference,
    ...
    const peg$c81 = function (values) {
        return {
            type: 'objectDeclarationEntries',
            values,
        };
    };
    const peg$c82 = function (declarations) {
        return {
            type: 'objectValue',
            declarations,
        };
    };
    const peg$c83 = function (referenceFile, toImport) {
        return {
    ...
    const peg$c103 = function (path, field) {
        return {
    ...
    const peg$c109 = function (values) {
        return values;
    };
    const peg$c110 = /^[0]/;
    const peg$c111 = peg$classExpectation(["0"], false, false);
    const peg$c112 = /^[xX]/;
    const peg$c113 = peg$classExpectation(["x", "X"], false, false);
    const peg$c114 = /^[0-9a-fA-F]/;
    const peg$c115 = peg$classExpectation([["0", "9"], ["a", "f"], ["A", "F"]], false, false);
    const peg$c116 = "-";
    const peg$c117 = peg$literalExpectation("-", false);
    const peg$c118 = /^[0-9]/;
    const peg$c119 = peg$classExpectation([["0", "9"]], false, false);
    const peg$c120 = /^[eE]/;
    const peg$c121 = peg$classExpectation(["e", "E"], false, false);
    const peg$c122 = "+";
    ...
    const peg$c127 = function () { return -Infinity; };
    const peg$c128 = "inf";
    const peg$c129 = peg$literalExpectation("inf", true);
    const peg$c130 = function () { return Infinity; };
    const peg$c131 = function (number) {
        return number;
    };
    const peg$c132 = function (value) {
        return value;
    };
    const peg$c133 = peg$otherExpectation("\"");
    const peg$c134 = "\"";
    const peg$c135 = peg$literalExpectation("\"", false);
    const peg$c136 = function (contents) {
        return contents;
    };
    const peg$c137 = peg$otherExpectation("'");
    const peg$c138 = "'";
    const peg$c139 = peg$literalExpectation("'", false);
    const peg$c140 = peg$otherExpectation("String Character");
    const peg$c141 = function () { return text(); };
    const peg$c142 = "\\";
    const peg$c143 = peg$literalExpectation("\\", false);
    const peg$c144 = peg$anyExpectation();
    const peg$c145 = function (v) { return v[1] === "'" ? "'" : v[0] + v[1]; };
    const peg$c146 = function (v) { return v[1] === '"' ? '"' : v[0] + v[1]; };
    const peg$c147 = "'''";
    const peg$c148 = peg$literalExpectation("'''", false);
    const peg$c149 = function (contents) {
        return contents;
    };
    const peg$c150 = "\"\"\"";
    ...
    const peg$c154 = peg$otherExpectation("end of line");
    const peg$c155 = "\n";
    const peg$c156 = peg$literalExpectation("\n", false);
    const peg$c157 = "\r\n";
    const peg$c158 = peg$literalExpectation("\r\n", false);
    const peg$c159 = "\r";
    const peg$c160 = peg$literalExpectation("\r", false);
    const peg$c161 = "\u2028";
    ...
    const peg$c168 = peg$otherExpectation("NON_LINE_WHITESPACE");
    const peg$c169 = /^[ \t\r]/;
    const peg$c170 = peg$classExpectation([" ", "\t", "\r"], false, false);
    let peg$currPos = 0;
    let peg$savedPos = 0;
