...
function peg$parse(input, options) {
    ...
    const peg$c100 = function (path, field) {
        return {
    ...
    const peg$c105 = function (values) {
        return values ?? [];
    };
    const peg$c106 = function (values) {
        return values;
    };
    const peg$c107 = /^[0]/;
    ...
    const peg$c138 = function () { return text(); };
    const peg$c139 = "\\";
    const peg$c140 = peg$literalExpectation("\\", false);
    const peg$c141 = peg$anyExpectation();
    const peg$c142 = function (v) { return v[1] === "'" ? "'" : v[0] + v[1]; };
    const peg$c143 = function (v) { return v[1] === '"' ? '"' : v[0] + v[1]; };
    const peg$c144 = "'''";
    const peg$c145 = peg$literalExpectation("'''", false);
    const peg$c146 = function (contents) {
        return contents;
    };
    const peg$c147 = "\"\"\"";
